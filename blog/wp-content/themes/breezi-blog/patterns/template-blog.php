 ...
 * Slug: breezi-blog/template-blog
 * Categories: pages
...
<hr class="wp-block-separator has-text-color has-alpha-channel-opacity is-style-wide" style="margin-top:var(--wp--preset--spacing--spacing-48);margin-bottom:var(--wp--preset--spacing--spacing-48)"/>
<!-- /wp:separator -->
